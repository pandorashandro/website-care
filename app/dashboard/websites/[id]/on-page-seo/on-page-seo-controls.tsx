...
/**
 * Phase 28 — mirrors site-architecture-controls.tsx exactly: analysis is a
 ...
 */
export default function OnPageSeoControls({ websiteId, crawlRunId, hasExistingAnalysis }: { websiteId: string; crawlRunId: string; hasExistingAnalysis: boolean }) {
  ...
  async function handleAnalyze() {
    ...
    try {
      const result = await analyzeOnPageCrawlRun(websiteId, crawlRunId)
      if (!result.ok) {

...
import { rollbackFix, type RollbackFixState } from './wordpress-rollback-actions'

const initialState: RollbackFixState = null
...
export default function UndoFixButton({
  websiteId,
  fixHistoryId,
  previousValue,
  appliedValue,
  ...
  const [state, formAction, pending] = useActionState(rollbackFix, initialState)

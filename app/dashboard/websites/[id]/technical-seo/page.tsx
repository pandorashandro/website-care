  ...
  return (
    <Container size="2xl" className="py-10">
      ...
      <Card padding="none" className="mt-4 overflow-hidden">
        <div className="h-1 w-full" style={{ backgroundColor: PILLAR_IDENTITY['technical-seo'].accent }} aria-hidden="true" />
        <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          <p className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide text-subtle">
            <Wrench className="h-3.5 w-3.5" style={{ color: PILLAR_IDENTITY['technical-seo'].accent }} aria-hidden="true" />
            Technical SEO
          </p>

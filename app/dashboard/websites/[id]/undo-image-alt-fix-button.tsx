...
import { rollbackImageAltFix, type RollbackImageAltFixState } from './wordpress-image-alt-rollback-actions'

const initialState: RollbackImageAltFixState = null
...
/** Mirrors undo-fix-button.tsx / undo-meta-fix-button.tsx, routed to the image-alt rollback action. */
export default function UndoImageAltFixButton({
  websiteId,
  fixHistoryId,
  previousValue,
  appliedValue,
  ...
  const [state, formAction, pending] = useActionState(rollbackImageAltFix, initialState)
